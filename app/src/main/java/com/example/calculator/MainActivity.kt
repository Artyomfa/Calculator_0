...
class MainActivity : AppCompatActivity() {
    var enter: String = "" // todo студия подсвечивает, что тут обозначать public не обязательно
    var output: String = ""// todo студия подсвечивает, что тут обозначать public не обязательно
    var int_enter: Int = 0// todo студия подсвечивает, что тут обозначать public не обязательно
    var dot: Boolean = false// todo студия подсвечивает, что тут обозначать public не обязательно
    ...
    private fun check_zero(){ //todo Данная функция должна быть private
        if (enter == "0") {
            enter = ""
            newTextFields("")
        }
    }
    private fun check_int() { //todo Данная функция должна быть private
        if (output.substringAfter(".") == "0")
            output = output.substringBefore(".")
    }

    private fun newTextFields(str: String) { //todo Данная функция должна быть private
        resultField.text = ""
